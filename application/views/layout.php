		    	...
		    	<div class="span3">
		    		<div>
		    			<a class="thumbnail" href="http://soporte.chilesinpapeleo.cl/" target="_blank">
		    				<img src="<?php echo base_url('assets/img/bnnr_consultas-solicitudes-soporte.png'); ?>" alt="Consulta y solicitudes de soporte.">
		    			</a>
					<a class="thumbnail" href="<?php echo site_url('page/view/simple'); ?>">
		    				<img src="<?php echo base_url('assets/img/bnnr_simple.png'); ?>" alt="Consulta y solicitudes de soporte.">
		    			</a>
					<a class="thumbnail" href="<?php echo site_url('page/view/claveunica'); ?>">
		    				<img src="<?php echo base_url('assets/img/bnnr_clave-unica.png'); ?>" alt="Consulta y solicitudes de soporte.">
		    			</a>
		    		</div>
		    		<br />
